defmodule Isupayx.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Isupayx.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    IsupayxWeb.Endpoint.config_change(changed, removed)
    :ok
  end
